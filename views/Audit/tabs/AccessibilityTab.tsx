...
export const AccessibilityTab: React.FC<Props> = ({
  ...
  return (
    <div className="flex flex-col gap-4 animate-in slide-in-from-left-2 mt-4">
      ...
      {score === 100 && !a11yAuditLoading && !hasIssues ? (
        <div className={`${BRUTAL.card} bg-white p-6 flex flex-col items-center justify-center text-center gap-4`}>
          ...
          <div className="max-w-xs">
            <h3 className="font-black uppercase text-xs mb-1">No issues detected</h3>
            <p className="text-[10px] text-gray-600 font-medium">
              This selection is looking great. Keep building consistent, accessible patterns and we&apos;ll flag anything that drifts.
            </p>
          </div>
        </div>
      ) : (
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3 mr-6 min-w-0">
                        <div className={`size-8 shrink-0 ${cat.color} border-2 border-black flex items-center justify-center text-sm leading-none shadow-[2px_2px_0_0_#000] text-black`}>{cat.icon}</div>
